class TokenData < ActiveRecord::Base
  ...
  attr_encrypted :access_token, key: DWOLLA_SECRET_KEY, mode: :per_attribute_iv_and_salt
  attr_encrypted :refresh_token, key: DWOLLA_SECRET_KEY, mode: :per_attribute_iv_and_salt
